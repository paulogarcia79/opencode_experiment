---
name: graphify
description: "Build a queryable knowledge graph from code, docs, papers, or images. Outputs: graphify-out/graph.html, GRAPH_REPORT.md, graph.json."
license: MIT
compatibility: Requires graphifyy Python package in .venv.
metadata:
  author: graphify
  version: "0.7.7"
---
...
# 0. Check local .venv first (this repo's venv)
if [ -z "$PYTHON" ] && [ -f ".venv/bin/python" ]; then
    if .venv/bin/python -c "import graphify" 2>/dev/null; then
