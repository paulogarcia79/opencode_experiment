...
class TestEditorArticlePermissions:
    ...
    def test_editor_can_create_article(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-create@test.com", "editor")
    ...
    def test_editor_can_list_articles(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-list@test.com", "editor")
    ...
    def test_editor_can_get_article(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-get@test.com", "editor")
        contributor_token = create_user_token(session, "contributor-for-get@test.com", "contributor")
    ...
    def test_editor_can_edit_any_article(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-edit@test.com", "editor")
        contributor_token = create_user_token(session, "contributor-for-edit@test.com", "contributor")
    ...
    def test_editor_can_publish_any_article(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-publish@test.com", "editor")
        contributor_token = create_user_token(session, "contributor-for-publish@test.com", "contributor")
    ...
    def test_editor_can_delete_any_article(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-delete@test.com", "editor")
        contributor_token = create_user_token(session, "contributor-for-delete@test.com", "contributor")
    ...
    def test_editor_can_autosave_any_article(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-autosave@test.com", "editor")
        contributor_token = create_user_token(session, "contributor-for-autosave@test.com", "contributor")
...
class TestEditorTagPermissions:
    ...
    def test_editor_can_list_tags(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-tags@test.com", "editor")
    ...
    def test_editor_can_delete_tag(self, client: TestClient, session: Session):
        ...
        editor_token = create_user_token(session, "editor-delete-tag@test.com", "editor")
...
class TestEditorImportPermissions:
    ...
    def test_editor_can_access_import_endpoint(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-import@test.com", "editor")
...
class TestEditorImagePermissions:
    ...
    def test_editor_can_list_images(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-images@test.com", "editor")
...
class TestEditorAnalyticsPermissions:
    ...
    def test_editor_can_access_analytics(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-analytics@test.com", "editor")
...
class TestEditorRevisionPermissions:
    ...
    def test_editor_can_list_revisions(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-revisions@test.com", "editor")
        contributor_token = create_user_token(session, "contributor-for-revisions@test.com", "contributor")
    ...
    def test_editor_can_get_revision(self, client: TestClient, session: Session):
        ...
        editor_token = create_user_token(session, "editor-get-rev@test.com", "editor")
    ...
    def test_editor_can_restore_revision(self, client: TestClient, session: Session):
        from app.services.revision_service import create_revision
        editor_token = create_user_token(session, "editor-restore-rev@test.com", "editor")
...
class TestEditorPreviewPermissions:
    ...
    def test_editor_can_preview_email(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-preview@test.com", "editor")
...
class TestEditorBlockedPermissions:
    ...
    def test_editor_cannot_access_users_list(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-blocked-users@test.com", "editor")
    ...
    def test_editor_cannot_invite_user(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-blocked-invite@test.com", "editor")
        response = client.post(
    ...
    def test_editor_cannot_update_user_role(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-blocked-role@test.com", "editor")
        admin = session.exec(select(User).where(User.email == "admin@example.com")).first()
        if admin is None:
            admin_token = create_user_token(session, "temp-admin@test.com", "admin")
    ...
    def test_editor_cannot_toggle_user_active(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-blocked-active@test.com", "editor")
        admin_token = create_user_token(session, "temp-admin-active@test.com", "admin")
    ...
    def test_editor_cannot_reassign_article(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor-blocked-reassign@test.com", "editor")
        contributor_token = create_user_token(session, "contributor-for-reassign@test.com", "contributor")
