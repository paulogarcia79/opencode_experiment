...
class TestArticleReassignment:
    ...
    def test_admin_can_reassign_article(self, client: TestClient, session: Session):
        admin_token = create_user_token(session, "admin_reassign@test.com", "admin")
        new_author_token = create_user_token(session, "new_author@test.com", "editor")
    ...
    def test_reassign_creates_revision(self, client: TestClient, session: Session):
        admin_token = create_user_token(session, "admin_rev@test.com", "admin")
        new_author_token = create_user_token(session, "new_author_rev@test.com", "editor")
    ...
    def test_reassign_returns_404_if_article_not_found(self, client: TestClient, session: Session):
        admin_token = create_user_token(session, "admin_404@test.com", "admin")
        new_author_token = create_user_token(session, "new_author_404@test.com", "editor")
    ...
    def test_reassign_returns_403_for_contributor(self, client: TestClient, session: Session):
        contributor_token = create_user_token(session, "contributor_reassign@test.com", "contributor")
        new_author_token = create_user_token(session, "new_author_contrib@test.com", "editor")
    ...
    def test_reassign_returns_400_if_target_user_not_found(self, client: TestClient, session: Session):
        admin_token = create_user_token(session, "admin_400@test.com", "admin")
    ...
    def test_reassign_returns_400_if_target_user_inactive(self, client: TestClient, session: Session):
        admin_token = create_user_token(session, "admin_inactive@test.com", "admin")
        inactive_user = create_user(session, "inactive@test.com", role="editor", is_active=False)
    ...
    def test_editor_cannot_reassign_article(self, client: TestClient, session: Session):
        editor_token = create_user_token(session, "editor_reassign@test.com", "editor")
        new_author_token = create_user_token(session, "new_author_editor@test.com", "admin")
    ...
    def test_reassign_with_existing_author(self, client: TestClient, session: Session):
        admin_token = create_user_token(session, "admin_existing@test.com", "admin")
        old_author_token = create_user_token(session, "old_author@test.com", "contributor")
        old_author = session.exec(select(User).where(User.email == "old_author@test.com")).first()
        new_author_token = create_user_token(session, "new_author_existing@test.com", "editor")
